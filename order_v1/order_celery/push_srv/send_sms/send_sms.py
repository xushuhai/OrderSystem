...
ACCESS_KEY_ID = "LTAIs7PcdHLN3RpY"
ACCESS_KEY_SECRET = "mlMaYb3uAzZrHf01IbS0lzVZyxeleR"
...
#     # params = "{\"code\":\"12345\",\"product\":\"云通信\"}"
    params = "{\"code\":\"--XXX--\"}"
    result = send_sms(__business_id, "13956461286", "木叶苍蓝", "SMS_109460219", params)
    # result = send_sms(__business_id, "17621036594", "木叶苍蓝", "SMS_109460219", params)
    print result
#     result = json.loads(result)
#     print str(result['Message']) == 'OK'
